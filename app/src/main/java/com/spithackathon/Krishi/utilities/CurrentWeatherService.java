...
import static com.spithackathon.Krishi.activities.WeatherActivity.mCitySearch;
import static com.spithackathon.Krishi.activities.WeatherActivity.mWeather;
...
public class CurrentWeatherService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        Connection connectionDetector = new Connection(this);
