...
import com.spithackathon.Krishi.adapters.WeatherForecastAdapter;
...
import com.spithackathon.Krishi.utilities.LanguageUtil;
import com.spithackathon.Krishi.utilities.PreferenceUtil;
...
import static com.spithackathon.Krishi.utilities.Utils.getWeatherForecastUrl;
...
public class WeatherForecastActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mConnectionDetector = new Connection(this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.menu_forecast_refresh:
                if (mConnectionDetector.isInternet()) {
                    getWeather();
